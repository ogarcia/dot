# This file is sourced by .bashrc. This script contains a set of options for
# the program less(1) (another pager).

# If less(1) is not installed into PATH then continue the loading of other
# files in bash_autoload.d directory.
if ! installed less
	then return 0
fi
...
export LESS="-R -J -K -M -x4 -PM[48;5;233m[38;5;75m$in_mprompt[0;0m"
