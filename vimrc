" vimrc
"
" Copyright (c) 2006-2015  Connectical
"
...
if has("syntax") || has("gui_running")
	...
	" Remove background color to SignColumn
...
function <SID>OpenExploreBuffer()
	if (bufname("%") != ".")
...
map  <F4>   :call <SID>OpenExploreBuffer()<CR>
imap <F4>   <ESC>:call <SID>OpenExploreBuffer()<CR>
